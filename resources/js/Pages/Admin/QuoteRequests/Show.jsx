                    ...
                    {(request.quote_file || request.policy_file) && (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div className="space-y-3">
                                {request.quote_file && (Array.isArray(request.quote_file) ? (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-semibold text-blue-900">Quote Document {request.quote_file.length > 1 ? ` ${idx + 1}` : ''}</p>
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-indigo-900">Premium Document</p>
                                                    <p className="text-sm text-indigo-700">Click to download</p>
                                                </div>
                                            </div>
