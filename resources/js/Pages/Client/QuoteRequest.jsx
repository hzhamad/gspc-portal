                            ...
                            <div ref={dependentsRef} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6 scroll-mt-20 md:scroll-mt-24">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center px-3 sm:px-4 py-2 bg-gold text-white font-semibold rounded-lg hover:brightness-110 transition-all text-sm sm:text-base"
                                    >
                        ...
                        {applicationType && (
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-0">
                                <button
                                    ...
                                    className="px-6 py-3 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors text-sm sm:text-base"
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="px-6 sm:px-8 py-3 bg-gold text-white font-semibold rounded-lg hover:brightness-110 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
                                >
                                    {processing ? (
                                        <>
