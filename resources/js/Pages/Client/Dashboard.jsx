...
export default function ClientDashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            {/* Unified Sidebar */}
            <DashboardAside currentPath="/client/dashboard" />
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center px-4 sm:px-6 py-3 bg-gold text-white font-semibold rounded-lg hover:brightness-110 transition-colors shadow-lg text-sm sm:text-base"
                                >
                                    <svg className="w-5 h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                    </svg>
                                    <span className="hidden sm:inline">New Application</span>
                                    <span className="sm:hidden ml-1">Apply</span>
                                </button>
                            </div>
